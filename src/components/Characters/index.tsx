...
export default function Characters() {
  ...
  return (
    <section id="characters" className="bg-[url(/background-paper.png)] bg-center bg-no-repeat bg-size-[1600px_95%] lg:bg-size-[110%_88%] w-full min-h-screen overflow-x-hidden py-12 pt-10 pl-0 md:pl-0 lg:pl-10 mt-6 lg:mt-0 lg:mb-0 ">
